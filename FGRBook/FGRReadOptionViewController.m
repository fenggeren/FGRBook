...
- (void)configTableView
{
    ...
    table.backgroundColor = [[UIColor alloc] initWithRed:0.2 green:0.2 blue:0.2 alpha:0.95];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([cell isKindOfClass:FGRReadOptionCell.class]) {
        FGRReadOptionCell *realCell = (FGRReadOptionCell *)cell;
        realCell.iconImage.image = [UIImage imageNamed:@"arrowRight"];
        [realCell configIconImage:NO];
    }

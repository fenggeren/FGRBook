...
- (void)viewDidLoad {
    ...
    containerView.backgroundColor = [[UIColor alloc] initWithRed:0.2 green:0.2 blue:0.2 alpha:0.95];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.iconImage.image = [UIImage imageNamed:@"checked"];
    [cell configIconImage:YES];
...
#define kReadOptionConfigNoti @"kReadOptionConfigNoti"
    ...
    if (self.optionType == FGRReadOptionTypeFlipStyle ||
        self.optionType == FGRReadOptionTypeLanguage) {
        [MBProgressHUD bwm_showTitle:@"程序猿GG正努力开发该功能" toView:self.navigationController.view hideAfter:2.];
    }
}
